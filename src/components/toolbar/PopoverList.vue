...
<template>
  <Popover v-slot="{ open, close }" class="relative">
    ...
    >
      <PopoverPanel
        class="absolute left-0 z-10 mt-2 w-fit p-2 border border-neutral-200 bg-white dark:bg-neutral-900/60 backdrop-blur backdrop-filter rounded-2xl shadow-lg transition"
      >
