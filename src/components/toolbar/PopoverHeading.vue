...
<template>
  <Popover v-slot="{ open, close }" class="relative">
    ...
    >
      <PopoverPanel
        class="absolute left-0 z-10 bottom-9 lg:bottom-auto lg:mt-1.5 w-fit p-2 border border-neutral-200 dark:border-neutral-100/20 bg-white dark:bg-neutral-900/80 backdrop-blur backdrop-filter rounded-2xl shadow-lg transition hidden lg:block"
      >
