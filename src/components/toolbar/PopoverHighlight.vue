...
<template>
  <Popover v-slot="{ open }" class="relative">
    ...
    >
      <PopoverPanel
        class="absolute bottom-9 lg:bottom-auto left-1/2 -translate-x-1/2 transform z-10 lg:mt-2 w-fit p-2 bg-white dark:bg-neutral-900/60 backdrop-filter backdrop-blur rounded-2xl shadow-lg transition border border-neutral-100 dark:border-neutral-100/20"
      >
